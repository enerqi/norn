...
is_1n_marmic_swedish_club_resp :: proc(hand: norn.Hand) -> bool {
...
is_2s_swedish_club_resp :: proc(hand: norn.Hand) -> bool {
...
is_2cd_swedish_club_resp :: proc(hand: norn.Hand) -> bool {
	points := norn.hcp(hand)
...
is_2h_or_2n_swedish_club_resp :: proc(hand: norn.Hand) -> bool {
	points := norn.hcp(hand)
...
is_1d_swedish_club_resp :: proc(hand: norn.Hand) -> bool {
	points := norn.hcp(hand)
	if points > 9 {
		return false
	}
...
is_minor_swedish_club_positive_response :: proc(hand: norn.Hand) -> bool {
	if is_2s_swedish_club_resp(hand) {
		return true
	}
...
is_1n_unbal_minor_swedish_club_resp :: proc(hand: norn.Hand) -> bool {
	if norn.hcp(hand) < 12 {
		return false
	}
...
is_old_1n_bal_swedish_club_response :: proc(hand: norn.Hand) -> bool {
	if norn.hcp(hand) < 12 {
		return false
	}
...
is_any_1n_swedish_club_response :: proc(hand: norn.Hand) -> bool {
	return(
...
eq_3_control_points_and_max_12_hcp :: proc(hand: norn.Hand) -> bool {
...
is_akqj :: proc(hand: norn.Hand, suit: norn.Suit) -> bool {
...
is_3n_swedish_club_resp :: proc(hand: norn.Hand) -> bool {
...
is_4cd_swedish_club_response :: proc(hand: norn.Hand) -> bool {
...
is_4hs_swedish_club_response :: proc(hand: norn.Hand) -> bool {
	if !eq_3_control_points_and_max_12_hcp(hand) {
		return false
	}
	return(
...
is_3x_preempt_swedish_club_response :: proc(hand: norn.Hand) -> bool {
	if norn.hcp(hand) > 7 {
		return false
	}
	return(
...
is_possible_inverted_diamond_raise :: proc(hand: norn.Hand) -> bool {
	if norn.hcp(hand) < 10 {
		return false
	}
...
is_possible_wjs_1d_response :: proc(hand: norn.Hand) -> bool {
	if norn.hcp(hand) >= 10 {
		return false
	}
...
is_possible_splinter_1d_response :: proc(hand: norn.Hand) -> bool {
	if norn.hcp(hand) < 13 {
		return false
	}
...
is_possible_diamond_preempt_1d_response :: proc(hand: norn.Hand) -> bool {
	if norn.hcp(hand) > 10 {
		return false
	}
