...
long_semi_solid :: proc(hand: norn.Hand, suit: norn.Suit) -> bool {
...
good_6_plus_suit :: proc(hand: norn.Hand, suit: norn.Suit) -> bool {
...
any_good_6_plus_carder :: proc(hand: norn.Hand) -> bool {
	return(
...
// `two_suiter`.)
two_suiter :: proc(hand: norn.Hand) -> bool {
	return(
...
is_6_plus_other_10_card_two_suiter :: proc(hand: norn.Hand) -> bool {
	return(
		has_pattern(hand, 6, 4, 2, 1) ||
		has_pattern(hand, 6, 4, 3, 0) ||
...
is_asymmetric_10_plus_two_suiter :: proc(hand: norn.Hand) -> bool {
	return(
		has_pattern(hand, 6, 4, 2, 1) ||
		has_pattern(hand, 6, 4, 3, 0) ||
		has_pattern(hand, 6, 5, 2, 0) ||
...
is_6_plus_other_11_or_more_card_two_suiter :: proc(hand: norn.Hand) -> bool {
	return(
		has_pattern(hand, 6, 5, 2, 0) ||
		has_pattern(hand, 6, 5, 1, 1) ||
...
// `is_tricky_suit`.)
is_tricky_suit :: proc(hand: norn.Hand, suit: norn.Suit) -> bool {
...
side_ace :: proc(hand: norn.Hand, suit: norn.Suit) -> bool {
